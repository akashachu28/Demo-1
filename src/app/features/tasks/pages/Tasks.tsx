              ...
              <div className="relative group">
                ...
                <div className="absolute right-0 mt-1 w-48 bg-white rounded-lg shadow-lg border border-gray-200 py-1 px-1 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-10">
                  <button
                    ...
                    className={`w-full text-left px-3 py-1.5 rounded-sm text-sm hover:bg-gray-50 transition-colors ${locationFilter === 'all' ? 'text-cyan-600 bg-cyan-50' : 'text-gray-700'}`}
                  >
                    All Locations
                  </button>
                  {locations.map(loc => (
                    <button
                      ...
                      className={`w-full text-left px-3 py-1.5 rounded-sm text-sm hover:bg-gray-50 transition-colors ${locationFilter === loc ? 'text-cyan-600 bg-cyan-50' : 'text-gray-700'}`}
                    >
                      {loc}
                    </button>
                  ))}
              ...
              <div className="relative group">
                ...
                <div className="absolute right-0 mt-1 w-48 bg-white rounded-lg shadow-lg border border-gray-200 py-1 px-1 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-10">
                  ...
                  <button
                    ...
                    className={`w-full text-left px-3 py-1.5 rounded-sm text-sm hover:bg-gray-50 transition-colors ${statusFilter === 'critical' ? 'text-cyan-600 bg-cyan-50' : 'text-gray-700'}`}
                  >
                    Critical
                  </button>
                  <button
                    onClick={() => setStatusFilter('high')}
                    className={`w-full text-left px-3 py-1.5 rounded-sm text-sm hover:bg-gray-50 transition-colors ${statusFilter === 'high' ? 'text-cyan-600 bg-cyan-50' : 'text-gray-700'}`}
                  >
                    High Priority
                  </button>
                  <button
                    onClick={() => setStatusFilter('medium')}
                    className={`w-full text-left px-3 py-1.5 rounded-sm text-sm hover:bg-gray-50 transition-colors ${statusFilter === 'medium' ? 'text-cyan-600 bg-cyan-50' : 'text-gray-700'}`}
                  >
                    Medium Priority
                  </button>
                </div>
