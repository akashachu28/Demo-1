...
export function Layout() {
  ...
  return (
    <div className="h-screen bg-[#0E4665] flex overflow-hidden">
      {/* Sidebar - Fixed */}
      <aside className={`${isCollapsed ? 'w-16' : 'w-64'} bg-[#0E4665] border-r border-gray-800 flex-shrink-0 flex flex-col transition-all duration-300 h-screen`}>
        {/* Logo */}
        <div className={`${isCollapsed ? 'p-4 py-7' : 'p-6'} border-b border-gray-800 bg-white flex items-center justify-between flex-shrink-0`}>
